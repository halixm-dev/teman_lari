...
void main() {
  testWidgets(
    'WeeklyVolumeChart renders correctly and calculates max correctly',
    (WidgetTester tester) async {
      ...
      final stats = RunningStats(
        ...
        weeklyVolume: {currentWeekKey: 2.3},
        weeklyMinutes: {currentWeekKey: 15.0},
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(body: WeeklyVolumeChart(stats: stats)),
        ),
      );
